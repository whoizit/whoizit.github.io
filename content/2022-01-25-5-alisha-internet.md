...
Самая популярная **Copyleft** лицензия это GNU General Public License (GNU GPL или просто GPL), её автор Ричард Мэттью Столман (RMS), так же является одним из разработчиков базовой системы GNU. Главный лоббист copyleft лицензии. Дедушка всего open-source сообщества. Хакер.
