...
Алиша начал выбирать дистрибьютив очень смешно, он открыл сайты [Fedora](https://getfedora.org/ru/) и [Arch](https://archlinux.org). И сказал - вот сайт Fedora на русском. *(Как будто бы это преимущество)*
