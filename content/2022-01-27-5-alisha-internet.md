...
Я пользуюсь самыми разными Linux'ами c 2007-2008 года и могу многое об этом рассказать.
...
Алиша начал выбирать дистрибьютив очень смешно, он открыл сайты [Fedora](https://getfedora.org/ru/) и [Arch](https://archlinux.org). И сказал - вот сайт Fedora на русском. *(Как будто бы это преимущество. Он его один раз откроет, скачает ISOшник и закроет. А в Wiki там и русского языка то нет. Я ОРУ)*
