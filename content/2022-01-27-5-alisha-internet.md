...
Теперь ты понял что Windows и MacOS проприетарные операционные системы и запрещают тебе всё что можно запретить. \*BSD имеет пермиссивную лицензию и разрешает корпорация воровать код. А ОС Linux использует вирусную лицензию GNU GPL и запрещает корпорациям воровать код.
